...
class RestaurantesController extends Controller
{
	...
	{
        $restaurantes = $this->restaurantesRepository->todosOrdenados();
...
//        dd($restaurantes);
		...
		return view('admin.restaurantes.show')->with('restaurantes', $restaurantes);
	}
	...
	public function edit($id)
	{
		...
		return view('admin.restaurantes.edit')->with('restaurantes', $restaurantes);
	}
